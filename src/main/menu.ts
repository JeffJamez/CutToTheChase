      ...
      submenu: [
        {
          ...
          click() {
            electron.shell.openExternal(usageUrl);
          },
        },
        {
          label: esc(t("FAQ")),
          click() {
            electron.shell.openExternal(faqUrl);
          },
        },
        {
          label: esc(t("Troubleshooting")),
          click() {
            electron.shell.openExternal(troubleshootingUrl);
          },
        },
        {
        ...
        },
        {
          ...
          click() {
            electron.shell.openExternal(featureRequestUrl);
          },
        },
        ...(!isStoreBuild
          ? [
              {
                ...
                click() {
                  electron.shell.openExternal(thanksUrl);
                },
              },
            ]
          : []),
        { type: "separator" },
        {
          ...
          click() {
            electron.shell.showItemInFolder(getConfigPath());
          },
        },
        {
        ...
        { type: "separator" },
        {
          ...
          click() {
            electron.shell.openExternal(licensesUrl);
          },
        },
        ...(process.platform !== "darwin"
          ? [{ role: "about" as const, label: esc(t("About CutToTheChase")) }]
          : []),
      ],
    },
  ];
