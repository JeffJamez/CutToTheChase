...
CutToTheChase is based on Electron which routinely drops support for old OS versions, and therefore CutToTheChase will also do so. [More info](https://github.com/mifi/lossless-cut/discussions/1476#discussioncomment-5012521). Note that older versions of CutToTheChase still work on older operating systems.
