...
CutToTheChase is **not** a portable app. If you install it from the Mac App Store or Microsoft Store, it is somewhat portable because it will be containerized by the operating system, so that when you uninstall the app there will most likely not be many traces of it left. You _can_ however customise where settings are stored, see below.
...
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| Windows                    | `%APPDATA%\CutToTheChase`                                                                                              | [What is `%APPDATA%`?](https://superuser.com/questions/632891/what-is-appdata) |
| Windows (MS Store Version) | `C:\Users\%USERNAME%\AppData\Local\Packages\57275mifi.no.CutToTheChase_eg8x93dt4dxje\LocalCache\Roaming\CutToTheChase` | [\*Not sure](https://github.com/mifi/lossless-cut/discussions/2167)            |
| MacOS                      | `~/Library/Application Support/CutToTheChase`                                                                          |                                                                                |
| MacOS (App Store version)  | `~/Library/Containers/no.mifi.CutToTheChase/Data/Library/Application Support/CutToTheChase`                            |                                                                                |
| Linux                      | `$XDG_CONFIG_HOME/CutToTheChase` or `~/.config/CutToTheChase`                                                          |                                                                                |
...
Because CutToTheChase is Open Source (GPL), there are many people and organizations who publish their own variant of CutToTheChase for example portableapps.com. This is fine, however **I don't provide support for those versions**.
